...
- **Relation to Main Product:** The PoC is a subset of the full workflow, focusing on end-to-end prompt generation and technical analysis for a single epic/codebase.

For the full product vision, see the [Product Requirements Document](./PRODUCT_REQUIREMENTS.md) and [Architecture Overview](./ARCHITECTURE.md).
...
5. Save the Copilot/LLM response for documentation and planning
...
*For the full product vision and architecture, see [PRODUCT_REQUIREMENTS.md](./PRODUCT_REQUIREMENTS.md) and [ARCHITECTURE.md](./ARCHITECTURE.md). For extension usage, see [USER_GUIDE.md](./USER_GUIDE.md).* 